...
func Test_aigentchat_PromptsAPIService(t *testing.T) {
	...
	t.Run("Test PromptsAPIService DuplicatePrompt", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PromptsAPI.DuplicatePrompt(context.Background(), orgId, promptId).Execute()
