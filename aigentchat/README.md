...
*AgentTeamsAPI* | [**AddAgentToTeam**](docs/AgentTeamsAPI.md#addagenttoteam) | **Patch** /v1/organizations/{org_id}/agent-teams/{team_id}/add-agent/{agent_id} | Add an agent to a team
*AgentTeamsAPI* | [**CreateAgentTeam**](docs/AgentTeamsAPI.md#createagentteam) | **Post** /v1/organizations/{org_id}/agent-teams | Create a new agent team
*AgentTeamsAPI* | [**DeleteAgentTeam**](docs/AgentTeamsAPI.md#deleteagentteam) | **Delete** /v1/organizations/{org_id}/agent-teams/{team_id} | Delete an agent team
*AgentTeamsAPI* | [**GetAgentTeam**](docs/AgentTeamsAPI.md#getagentteam) | **Get** /v1/organizations/{org_id}/agent-teams/{team_id} | Get an agent team
*AgentTeamsAPI* | [**GetFullAgentTeam**](docs/AgentTeamsAPI.md#getfullagentteam) | **Get** /v1/organizations/{org_id}/agent-teams/{team_id}/full | Get a full agent team
*AgentTeamsAPI* | [**ListAgentTeams**](docs/AgentTeamsAPI.md#listagentteams) | **Get** /v1/organizations/{org_id}/agent-teams | List agent teams
*AgentTeamsAPI* | [**RemoveAgentFromTeam**](docs/AgentTeamsAPI.md#removeagentfromteam) | **Patch** /v1/organizations/{org_id}/agent-teams/{team_id}/remove-agent/{agent_id} | Remove an agent from a team
*AgentTeamsAPI* | [**UpdateAgentTeam**](docs/AgentTeamsAPI.md#updateagentteam) | **Put** /v1/organizations/{org_id}/agent-teams/{team_id} | Update an agent team
*AgentTeamsAPI* | [**UpdateSystemMessages**](docs/AgentTeamsAPI.md#updatesystemmessages) | **Patch** /v1/organizations/{org_id}/agent-teams/{team_id}/messages/system | Update system messages
*AgentTeamsAPI* | [**UpdateUserMessages**](docs/AgentTeamsAPI.md#updateusermessages) | **Patch** /v1/organizations/{org_id}/agent-teams/{team_id}/messages/user | Update user messages
...
*ChannelsAPI* | [**CreateChannelFile**](docs/ChannelsAPI.md#createchannelfile) | **Post** /v1/organizations/{org_id}/channels/{id}/files | Create a file for a channel
*ChannelsAPI* | [**DeleteChannel**](docs/ChannelsAPI.md#deletechannel) | **Delete** /v1/organizations/{org_id}/channels/{id} | Delete a channel
*ChannelsAPI* | [**GetActiveChannels**](docs/ChannelsAPI.md#getactivechannels) | **Get** /v1/organizations/{org_id}/channels/active | Get active channels
*ChannelsAPI* | [**GetChannel**](docs/ChannelsAPI.md#getchannel) | **Get** /v1/organizations/{org_id}/channels/{id} | Get a channel by ID
*ChannelsAPI* | [**GetChannelFileSettings**](docs/ChannelsAPI.md#getchannelfilesettings) | **Get** /v1/organizations/{org_id}/channels/file-settings | Get channel file settings
*ChannelsAPI* | [**GetChannelPresence**](docs/ChannelsAPI.md#getchannelpresence) | **Get** /v1/organizations/{org_id}/channels/{channel_id}/presence | Get channel presence
*ChannelsAPI* | [**GetUserSubscribedChannels**](docs/ChannelsAPI.md#getusersubscribedchannels) | **Get** /v1/organizations/{org_id}/channels/subscribed/{user_id} | Get user&#39;s subscribed channels
...
*MissionsAPI* | [**ListMissionsByExecutorID**](docs/MissionsAPI.md#listmissionsbyexecutorid) | **Get** /v1/organizations/{org_id}/missions/executor/{mission_executor_id} | List all missions by a executorID (Agent Team or Agent)
