...
*AdminAPI* | [**TransferResources**](docs/AdminAPI.md#transferresources) | **Post** /v1/organizations/{org_id}/admin/resource-transfers | Transfer a user&#39;s resources between organizations
...
*AgentsAPI* | [**ExportAgents**](docs/AgentsAPI.md#exportagents) | **Get** /v1/organizations/{org_id}/agents/export | Export agents as CSV
...
*AudioAPI* | [**CreateVoiceChatInput**](docs/AudioAPI.md#createvoicechatinput) | **Post** /v1/organizations/{org_id}/audio/voice-chat-input | Voice Chat Input
*AuditTrailsAPI* | [**GetAuditTrailsByChannelId**](docs/AuditTrailsAPI.md#getaudittrailsbychannelid) | **Get** /v1/organizations/{org_id}/audit-trails/channels/{channel_id} | Get the audit trails by channel ID
...
*ChannelsAPI* | [**SearchChannels**](docs/ChannelsAPI.md#searchchannels) | **Get** /v1/organizations/{org_id}/channels/search | Search channels by query
...
*ChatCompletionsAPI* | [**GetChatCompletionFileSettings**](docs/ChatCompletionsAPI.md#getchatcompletionfilesettings) | **Get** /v1/organizations/{org_id}/completions/file-settings | Get file settings for chat completions
*ChatCompletionsAPI* | [**GetChatCompletionStatus**](docs/ChatCompletionsAPI.md#getchatcompletionstatus) | **Get** /v1/organizations/{org_id}/completions/status/{client_message_id} | Get the status of a chat-completion request
...
*ExecutionLogsAPI* | [**CreateChatCompletionCosts**](docs/ExecutionLogsAPI.md#createchatcompletioncosts) | **Post** /v1/organizations/{org_id}/execution-logs/chat-completion-costs | Track chat completion costs
...
*ExecutionLogsAPI* | [**ListExecutionLogs**](docs/ExecutionLogsAPI.md#listexecutionlogs) | **Get** /v1/organizations/{org_id}/execution-logs | List execution logs
...
*ImagesAPI* | [**CancelImageGeneration**](docs/ImagesAPI.md#cancelimagegeneration) | **Post** /v1/organizations/{org_id}/images/cancel/{generation_id} | Cancel an image generation
...
*ImagesAPI* | [**DeleteImage**](docs/ImagesAPI.md#deleteimage) | **Delete** /v1/organizations/{org_id}/images/{image_id} | Delete an image
...
*MessagesAPI* | [**ListMessages**](docs/MessagesAPI.md#listmessages) | **Get** /v1/organizations/{org_id}/messages | List messages
...
*PromptsAPI* | [**DuplicatePrompt**](docs/PromptsAPI.md#duplicateprompt) | **Post** /v1/organizations/{org_id}/prompts/{prompt_id}/duplicate | Duplicate Prompt
*PromptsAPI* | [**ExportPrompts**](docs/PromptsAPI.md#exportprompts) | **Get** /v1/organizations/{org_id}/prompts/export | Export prompts as CSV
...
*TagsAPI* | [**CreateTag**](docs/TagsAPI.md#createtag) | **Post** /v1/organizations/{org_id}/tags | Create a new tag
*TagsAPI* | [**DeleteTag**](docs/TagsAPI.md#deletetag) | **Delete** /v1/organizations/{org_id}/tags/{id} | Delete a tag
*TagsAPI* | [**GetTag**](docs/TagsAPI.md#gettag) | **Get** /v1/organizations/{org_id}/tags/{id} | Get a tag
*TagsAPI* | [**ListTags**](docs/TagsAPI.md#listtags) | **Get** /v1/organizations/{org_id}/tags | List tags
*TagsAPI* | [**UpdateTag**](docs/TagsAPI.md#updatetag) | **Patch** /v1/organizations/{org_id}/tags/{id} | Update a tag
...
## Documentation For Models
 ...
 - [AIModelStats](docs/AIModelStats.md)
 ...
 - [AIgencyMessageCompletionParameters](docs/AIgencyMessageCompletionParameters.md)
 ...
 - [AgentResults](docs/AgentResults.md)
 ...
 - [ChannelContextWindow](docs/ChannelContextWindow.md)
 ...
 - [FunctionCallRequestDto](docs/FunctionCallRequestDto.md)
 ...
 - [PromptConstant](docs/PromptConstant.md)
 - [PromptContent](docs/PromptContent.md)
 - [PromptContentType](docs/PromptContentType.md)
 - [PromptReference](docs/PromptReference.md)
 - [PromptRenderDto](docs/PromptRenderDto.md)
 - [PromptResults](docs/PromptResults.md)
 - [PromptStatistics](docs/PromptStatistics.md)
 - [PromptVariable](docs/PromptVariable.md)
 - [PromptVariableOption](docs/PromptVariableOption.md)
 - [PromptVersion](docs/PromptVersion.md)
 - [PromptWriteDto](docs/PromptWriteDto.md)
 - [RenderedPrompt](docs/RenderedPrompt.md)
 - [ResourceTransferRequest](docs/ResourceTransferRequest.md)
 - [ResourceTransferResult](docs/ResourceTransferResult.md)
 - [ResultFile](docs/ResultFile.md)
 - [ServiceStatus](docs/ServiceStatus.md)
 - [Tag](docs/Tag.md)
 - [TagResults](docs/TagResults.md)
 - [TagWriteDto](docs/TagWriteDto.md)
 ...
 - [Tool](docs/Tool.md)
 - [ToolContinuationInstructions](docs/ToolContinuationInstructions.md)
 - [ToolFunction](docs/ToolFunction.md)
 - [ToolI18n](docs/ToolI18n.md)
 - [TransferableResourceType](docs/TransferableResourceType.md)
 - [UserAccessView](docs/UserAccessView.md)
