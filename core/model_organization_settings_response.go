...
type OrganizationSettingsResponse struct {
	AllowedHostingLocations []string `json:"allowedHostingLocations"`
	AllowedPredefinedAgentIds []string `json:"allowedPredefinedAgentIds"`
...
func NewOrganizationSettingsResponse(allowedHostingLocations []string, allowedPredefinedAgentIds []string, createdAt string, defaultAgentId string, id string, organizationId string, updatedAt string) *OrganizationSettingsResponse {
	...
	this.AllowedHostingLocations = allowedHostingLocations
	this.AllowedPredefinedAgentIds = allowedPredefinedAgentIds
...
// GetAllowedHostingLocations returns the AllowedHostingLocations field value
...
// GetAllowedHostingLocationsOk returns a tuple with the AllowedHostingLocations field value
...
// SetAllowedHostingLocations sets field value
func (o *OrganizationSettingsResponse) SetAllowedHostingLocations(v []string) {
	o.AllowedHostingLocations = v
}

// GetAllowedPredefinedAgentIds returns the AllowedPredefinedAgentIds field value
...
// GetAllowedPredefinedAgentIdsOk returns a tuple with the AllowedPredefinedAgentIds field value
// and a boolean to check if the value has been set.
...
// SetAllowedPredefinedAgentIds sets field value
...
func (o *OrganizationSettingsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	requiredProperties := []string{
		"allowedHostingLocations",
		"allowedPredefinedAgentIds",
		"createdAt",
		"defaultAgentId",
		"id",
		"organizationId",
