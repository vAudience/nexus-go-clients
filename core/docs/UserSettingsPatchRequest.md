...
`func (o *UserSettingsPatchRequest) GetOnboardingCompletedTours() []string`
...
`func (o *UserSettingsPatchRequest) GetOnboardingCompletedToursOk() (*[]string, bool)`
...
`func (o *UserSettingsPatchRequest) SetOnboardingCompletedTours(v []string)`
...
`func (o *UserSettingsPatchRequest) GetOnboardingState() string`

GetOnboardingState returns the OnboardingState field if non-nil, zero value otherwise.

### GetOnboardingStateOk

`func (o *UserSettingsPatchRequest) GetOnboardingStateOk() (*string, bool)`
...
`func (o *UserSettingsPatchRequest) SetOnboardingState(v string)`

SetOnboardingState sets OnboardingState field to given value.

### HasOnboardingState

`func (o *UserSettingsPatchRequest) HasOnboardingState() bool`
