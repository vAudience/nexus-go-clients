...
type UserSettingsPostRequest struct {
	...
	OnboardingCompletedTours []string `json:"onboardingCompletedTours,omitempty"`
...
// GetOnboardingCompletedTours returns the OnboardingCompletedTours field value if set, zero value otherwise.
func (o *UserSettingsPostRequest) GetOnboardingCompletedTours() []string {
	if o == nil || IsNil(o.OnboardingCompletedTours) {
		var ret []string
		return ret
	}
	return o.OnboardingCompletedTours
}

// GetOnboardingCompletedToursOk returns a tuple with the OnboardingCompletedTours field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSettingsPostRequest) GetOnboardingCompletedToursOk() ([]string, bool) {
	if o == nil || IsNil(o.OnboardingCompletedTours) {
		return nil, false
	}
	return o.OnboardingCompletedTours, true
}
...
// SetOnboardingCompletedTours gets a reference to the given []string and assigns it to the OnboardingCompletedTours field.
func (o *UserSettingsPostRequest) SetOnboardingCompletedTours(v []string) {
	o.OnboardingCompletedTours = v
}
...
func (o *UserSettingsPostRequest) GetOnboardingState() string {
	if o == nil || IsNil(o.OnboardingState) {
		var ret string
		return ret
	}
	return *o.OnboardingState
}

// GetOnboardingStateOk returns a tuple with the OnboardingState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSettingsPostRequest) GetOnboardingStateOk() (*string, bool) {
	if o == nil || IsNil(o.OnboardingState) {
		return nil, false
	}
	return o.OnboardingState, true
}
...
// SetOnboardingState gets a reference to the given string and assigns it to the OnboardingState field.
...
func (o UserSettingsPostRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OnboardingCompletedTours) {
		toSerialize["onboardingCompletedTours"] = o.OnboardingCompletedTours
	}
	...
	if !IsNil(o.OnboardingState) {
		toSerialize["onboardingState"] = o.OnboardingState
	}
	if !IsNil(o.UserId) {
...
func (o *UserSettingsPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UserSettingsPostRequest(varUserSettingsPostRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "onboardingCompletedTours")
		delete(additionalProperties, "onboardingDone")
		delete(additionalProperties, "onboardingHoldUntil")
		delete(additionalProperties, "onboardingState")
