...
*AuthAPI* | [**Has2FA**](docs/AuthAPI.md#has2fa) | **Get** /v1/auth/2fa | Has 2FA configured
...
*AuthAPI* | [**Remove2FA**](docs/AuthAPI.md#remove2fa) | **Get** /v1/auth/2fa/remove | Remove 2FA
*AuthAPI* | [**Setup2FA**](docs/AuthAPI.md#setup2fa) | **Get** /v1/auth/2fa/setup | Setup 2FA
...
*OrganizationsAPI* | [**BulkInvite**](docs/OrganizationsAPI.md#bulkinvite) | **Post** /v1/organizations/{id}/invites/bulk | Bulk invite users to an Organization
...
*OrganizationsAPI* | [**CreateVaudCreditsPayment**](docs/OrganizationsAPI.md#createvaudcreditspayment) | **Post** /v1/organizations/{id}/vaud-credits-payments | Create a vaud credits payment for an organization with active subscription
...
*OrganizationsAPI* | [**ExportMembers**](docs/OrganizationsAPI.md#exportmembers) | **Get** /v1/organizations/{id}/members/export | Export all members for an Organization as CSV
...
*OrganizationsAPI* | [**GetAllMyOrganizationsWithDetails**](docs/OrganizationsAPI.md#getallmyorganizationswithdetails) | **Get** /v1/organizations/me/details | Get all my organizations with details (subscriptions, ...)
...
*OrganizationsAPI* | [**GetMemberSettings**](docs/OrganizationsAPI.md#getmembersettings) | **Get** /v1/organizations/{id}/members/{memberId}/settings | Get member settings for an Organization
...
*OrganizationsAPI* | [**PatchMemberSettings**](docs/OrganizationsAPI.md#patchmembersettings) | **Patch** /v1/organizations/{id}/members/{memberId}/settings | Patch member settings for an Organization
...
*OrganizationsAPI* | [**ResetOrganizationSettings**](docs/OrganizationsAPI.md#resetorganizationsettings) | **Patch** /v1/organizations/{id}/settings/reset | Reset settings for an Organization to default values
...
*ProductsAPI* | [**GetProducts**](docs/ProductsAPI.md#getproducts) | **Get** /v1/products | Get all products
...
## Documentation For Models
 ...
 - [BulkInviteEntry](docs/BulkInviteEntry.md)
 - [BulkInviteResult](docs/BulkInviteResult.md)
 ...
 - [OrganizationBulkInviteRequest](docs/OrganizationBulkInviteRequest.md)
 - [OrganizationBulkInviteResponse](docs/OrganizationBulkInviteResponse.md)
 ...
 - [ProductI18nResponse](docs/ProductI18nResponse.md)
