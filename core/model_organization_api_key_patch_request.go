...
type OrganizationApiKeyPatchRequest struct {
	...
	RequiresRotation *bool `json:"requiresRotation,omitempty"`
	// Replaces the attached global roles. Requires the manage-api-key-roles:organizations permission (vaudience staff only) whenever the field is present, an empty array included — clearing roles is a staff action too. Product roles are never assignable: the active subscription's role is attached automatically. Omit the field entirely to leave the roles untouched.
...
// GetRequiresRotation returns the RequiresRotation field value if set, zero value otherwise.
func (o *OrganizationApiKeyPatchRequest) GetRequiresRotation() bool {
	if o == nil || IsNil(o.RequiresRotation) {
		var ret bool
		return ret
	}
	return *o.RequiresRotation
}

// GetRequiresRotationOk returns a tuple with the RequiresRotation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationApiKeyPatchRequest) GetRequiresRotationOk() (*bool, bool) {
	if o == nil || IsNil(o.RequiresRotation) {
		return nil, false
	}
	return o.RequiresRotation, true
}
...
// SetRequiresRotation gets a reference to the given bool and assigns it to the RequiresRotation field.
func (o *OrganizationApiKeyPatchRequest) SetRequiresRotation(v bool) {
	o.RequiresRotation = &v
}
...
func (o OrganizationApiKeyPatchRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RequiresRotation) {
		toSerialize["requiresRotation"] = o.RequiresRotation
	}
	if !IsNil(o.RoleIds) {
...
func (o *OrganizationApiKeyPatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = OrganizationApiKeyPatchRequest(varOrganizationApiKeyPatchRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "requiresRotation")
